...
export class Trap extends Ability {
    ...
    Execute(e: AbilityEvent) {
        ...
        // const missile = new TrapMissile(x, y, Trap.speed, Trap.travelDistance, angle)
        //     .OnUpdate((m) => {
        ...
        //             let knockForce = (1 + progress*progress*progress) * Trap.knockForce + Trap.knockForce;
        //             // knockForce = Trap.knockForce;
